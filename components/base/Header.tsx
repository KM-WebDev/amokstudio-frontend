...
export default function Header() {
    return (
        <header className="fixed top-0 right-0 left-0 z-10000">
            <div className="relative z-100000 flex w-full items-center justify-center bg-neutral-50/60 backdrop-blur-sm">
                <div className="flex w-full max-w-[1200px] items-center justify-between px-6 py-2 lg:py-0">
